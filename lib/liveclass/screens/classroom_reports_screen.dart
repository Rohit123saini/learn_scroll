...
class _ClassroomReportsScreenState extends State<ClassroomReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: liveClassAppBar('Classroom Reports'),
      body: Column(
        children: [
          Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  _filterChip('Reviewed', ReportStatus.reviewed),
                  _filterChip('Action Taken', ReportStatus.actionTaken),
                  _filterChip('Dismissed', ReportStatus.dismissed),
